...
<section class="intro-text">7 лет назад в далёкой галактике....</section>
...
<div class="main-text-wrapper">
	<div class="main-text">
		...
		<br />
		<p>
			Идет гражданская война. Космические корабли повстанцев, наносящие удар с тайной базы, одержали
			первую победу, в схватке со зловещей Галактической Империей. Во время сражения, разведчикам
			повстанцев удалось похитить секретные планы, связанные с главным оружием Империи - Звездой
			Смерти, бронированной космической станцией, способной уничтожить целую планету.
		</p>
		<br />
		<p>
			Преследуемая имперскими агентами принцесса Лея спешит домой на своем звездном корабле. При ней
			находятся похищенные планы, которые могут спасти ее народ и вернуть свободу галактике.
		</p>
	</div>
</div>
